...
- `slidesUrl` can point to a notes anchor (for example `/workshops#kinetic-kitchen-teaching`, `/workshops#policy-gatekeeper-teaching`, `/workshops#kinetic-proof-teaching`, `/workshops#vpn-cost-lab-teaching`, `/workshops#vibe-to-pral-teaching`, `/workshops#ghost-machine-teaching`, or `/workshops#leanagents-chatgpt-apps-teaching`) when a downloadable slide deck is not available.
